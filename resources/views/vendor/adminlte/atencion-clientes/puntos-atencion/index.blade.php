...
@section('contentheader_title')
    <h1><i class="fa fa-map-marker"></i>  Puntos de Atención</h1>
@endsection
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header bg-blue with-border">
                        <form class="navbar-form navbar-left" action="{{route('puntos-atencion.index')}}" role="search" method="GET">
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                @foreach($puntos_atencion as $punto_atencion)
                                <tr>
                    ...
                    <div class="box-footer clearfix">
                        <span class="dataTables_info" id="example2_info" role="status" aria-live="polite">Página {{$puntos_atencion->currentPage()}} de {{$puntos_atencion->lastPage()}}. Total registros {{$puntos_atencion->total()}}</span>
                        <!-- paginacion aquí -->
                        {!! $puntos_atencion->links() !!}
                    </div>
                </div>
            </div>
        </div>
