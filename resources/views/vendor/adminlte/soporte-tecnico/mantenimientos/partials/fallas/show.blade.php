<div class="panel panel-default">
  <div class="panel-heading bg-blue">
    <h2 class="panel-title"><i class="fa fa-exclamation"></i>  Fallas
  ...
  <div class="panel-body">
    ...
    <div class="row">
      <div class="col-md-12">
        @if($mantenimiento->fallas->count() > 0)
          <table class="table table-hover tabla-lista">
                @foreach($mantenimiento->fallas as $falla)
                <tr>
                    <td class="text-success text-big text-center" style="width:20px;"><i class="fa fa-check-square-o"></i></td>
                    <th>
                        {{$falla->tipo->DescipcionFallo}}
                        @if($mantenimiento->estado != 'CERRADO')
                        <div class="tools">
                            @permission('mantenimientos-fallos-eliminar')
                                <form action="{{ route('mantenimientos.fallas.destroy', [$mantenimiento_id, $falla->MantFallaId]) }}" method="post">
