                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        @permission('instalaciones-infraestructura-crear')
                                            <li><a href="{{route('instalaciones.instalar.infra')}}"><i class="fa fa-plus"></i> Instalar Infraestructura</a></li>
                                        @endpermission

                                        @permission('instalaciones-infraestructura-exportar')
                    ...
                    <div class="box-body table-responsive">
                        <table  id="areas" class="table table-bordered table-striped dataTable">
                            <tbody>
                                ...
                                <tr>
                                    <th>
                                        {{$dato->infraestructura->nombre}}
                                    </th>

                                    <td>{{$dato->infraestructura->categoria}}</td>      
                                    
                                    <td>{{$dato->infraestructura->tipo_categoria}}</td>   

                                    <td>{{$dato->infraestructura->municipio->NombreMunicipio}}</td> 
                                    
                                    <td>{{$dato->infraestructura->municipio->departamento->NombreDelDepartamento}}</td>                                    
                                    ...
                                    <td>
                                        @permission('instalaciones-infraestructura-editar')
                                            <a href="{{route('instalaciones.edit.infra', $dato->id)}}" class="btn btn-primary btn-xs"  target="_blank"> <i class="fa fa-edit"></i></a>
                                        @endpermission    

                                        @if($dato->estado == 'PENDIENTE')
                                        
                                            @permission('instalaciones-infraestructura-eliminar')
                                                <form action="{{route('instalaciones.destroy.infra', $dato->id)}}" method="post" style="display: inline-block;">
