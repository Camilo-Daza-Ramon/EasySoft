                ...
                <tr>
                  <td>
                    ...
                    <ol style="text-align: justify;">
                      ...
                      <li>Las tarifas sociales establecidas para el pago mensual del servicio de Internet, según las condiciones técnicas establecidas en el presente documento, corresponden a $8.613 pesos para estrato 1 y $19.074 pesos para estrato 2.
                    </li>
                    ...
                    <p><b>Tipo Servicio:</b> INTERNET <br>
                      <b>Plan:</b>  5 Mbps Downstream /1024 Kbps Upstream <br>
                      <b>Valor:</b>${{$data['valo_pagar']}}</p>
          ...
          <tr>
              ...
              <table width="100%">
                ...
                <tr>
                  <td style="border: solid 1px;">
                    <img src=".{{Storage::url($data['firma'])}}" width="210">
            ...
            <td width="50%">
              ...
              <table width="100%">
                <tr>
                  <td class="bg-morado">
                    <span>El usuario es el ÚNICO responsable por el contenido y la información que se curse a través de la red y del uso que se haga de los equipos o de los servicios.</span>
                  </td>
                </tr>                
              </table>
              ...
              <table width="100%">
                <tr>
                  <td class="bg-morado">
                    <span>Los equipos de comunicaciones que ya no use son desechos que no deben ser botados a la caneca, consulte nuestra política de recolección de aparatos en desuso.</span>
                  </td>
                </tr>                
              </table>
              ...
              <table class="table-bordered" width="100%">
                <tr>
                  <td colspan="2">
                    <img src=".{{Storage::url($data['firma'])}}" width="210"> <br>
                    <span>Aceptación contrato mediante firma o cualquier otro medio válido</span>
                  </td>
                </tr>
                <tr>
                  <td>
                    <span class="right">CC/CE {{$data['identificacion']}}</span>
                  </td>
                  <td>
                    <span class="right">FECHA {{$data['fecha_contrato']}}</span>
                  </td>
                </tr>
              </table>
