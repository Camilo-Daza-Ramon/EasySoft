...
class CreateCampanasRespuestasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('campanas_respuestas', function (Blueprint $table) {
    ...
    {
        //
        Schema::dropIfExists('campanas_respuestas');
