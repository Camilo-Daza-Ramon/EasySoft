...
<div class="row">
    ...
    <div class="form-group{{ $errors->has('marca_equipo') ? ' has-error' : '' }} col-md-3 col-xs-6">
        <label>*Marca </label>
        <input type="text" class="form-control" name="marca_equipo" placeholder="Marca" value="" >
        <span class="help-block"></span>
    </div>

    <div class="form-group{{ $errors->has('serial_equipo') ? ' has-error' : '' }} col-md-3 col-xs-6">
        <label>*Serial</label>
        <input type="text" class="form-control" name="serial_equipo" placeholder="Serial" value="" >
        <span class="help-block"></span>
    </div>
